...
void CFATRONGrenade::Fase10( void )
{
	...
	SetThink( EXTREMEFASE1 );
	pev->nextthink = gpGlobals->time + 6.0;
}

void CFATRONGrenade::EXTREMEFASE1( void )
{
	UTIL_ScreenShake( pev->origin, 5.0, 150.0, 10, 1000.0 );       	
	UTIL_ScreenFadeAll( Vector(255,0,0), 5, 1.0, 110, FFADE_IN );	
	...
	CBaseEntity::Create( "monster_FATRONlightning2", pev->origin, pev->angles, edict() );	
	RadiusDamage ( pev->origin, pev, pevOwner, 1, 1, CLASS_NONE );	

    CBaseEntity::Create( "effect_fatron", pev->origin, pev->angles, edict() );
    CBaseEntity::Create( "effect_fatron2", pev->origin, pev->angles, edict() );

	EMIT_SOUND(ENT(pev), CHAN_VOICE, "weapons/fatrongrenade/hl2ep1citadelexplosion.wav", 1, ATTN_NORM);

	SetThink( EXTREMEFASE2 );
	pev->nextthink = gpGlobals->time + 0.1;
}

void CFATRONGrenade::EXTREMEFASE2( void )
{
	UTIL_ScreenShake( pev->origin, 5.0, 150.0, 10, 1000.0 );       	
	UTIL_ScreenFadeAll( Vector(255,0,0), 5, 1.0, 110, FFADE_IN );
	...
	SetThink( EXTREMEFASE3 );
	pev->nextthink = gpGlobals->time + 0.2;
}

void CFATRONGrenade::EXTREMEFASE3( void )
{
	UTIL_ScreenShake( pev->origin, 5.0, 150.0, 10, 1000.0 );       	
	UTIL_ScreenFadeAll( Vector(255,0,0), 5, 1.0, 110, FFADE_IN );
	...
	SetThink( EXTREMEFASE4 );
	pev->nextthink = gpGlobals->time + 0.3;
}

void CFATRONGrenade::EXTREMEFASE4( void )
{
	UTIL_ScreenShake( pev->origin, 5.0, 150.0, 10, 1000.0 );       	
	UTIL_ScreenFadeAll( Vector(255,0,0), 5, 1.0, 110, FFADE_IN );
	...
	SetThink( EXTREMEFASE5 );
	pev->nextthink = gpGlobals->time + 0.4;
}

void CFATRONGrenade::EXTREMEFASE5( void )
{
	UTIL_ScreenShake( pev->origin, 5.0, 150.0, 10, 1000.0 );       	
	UTIL_ScreenFadeAll( Vector(255,0,0), 5, 1.0, 110, FFADE_IN );
	...
	SetThink( EXTREMEFASE6 );
	pev->nextthink = gpGlobals->time + 0.5;
}

void CFATRONGrenade::EXTREMEFASE6( void )
{
	UTIL_ScreenShake( pev->origin, 5.0, 150.0, 10, 1000.0 );       	
	UTIL_ScreenFadeAll( Vector(255,0,0), 5, 1.0, 110, FFADE_IN );
	...
	SetThink( EXTREMEFASE7 );
	pev->nextthink = gpGlobals->time + 0.6;
}

void CFATRONGrenade::EXTREMEFASE7( void )
{
	UTIL_ScreenShake( pev->origin, 5.0, 150.0, 10, 1000.0 );       	
	UTIL_ScreenFadeAll( Vector(255,0,0), 5, 1.0, 110, FFADE_IN );
	...
	SetThink( EXTREMEFASE8 );
	pev->nextthink = gpGlobals->time + 0.7;
}

void CFATRONGrenade::EXTREMEFASE8( void )
{
	UTIL_ScreenShake( pev->origin, 5.0, 150.0, 10, 1000.0 );       	
	UTIL_ScreenFadeAll( Vector(255,0,0), 5, 1.0, 110, FFADE_IN );
	...
	SetThink( EXTREMEFASE9 );
	pev->nextthink = gpGlobals->time + 0.8;
}

void CFATRONGrenade::EXTREMEFASE9( void )
{
	UTIL_ScreenShake( pev->origin, 5.0, 150.0, 10, 1000.0 );       	
	UTIL_ScreenFadeAll( Vector(255,0,0), 5, 1.0, 110, FFADE_IN );
	...
	SetThink( EXTREMEFASE10 );
	pev->nextthink = gpGlobals->time + 0.9;
}

void CFATRONGrenade::EXTREMEFASE10( void )
{
	UTIL_ScreenShake( pev->origin, 5.0, 150.0, 10, 1000.0 );       	
	UTIL_ScreenFadeAll( Vector(255,0,0), 5, 1.0, 110, FFADE_IN );
	...
	SetThink( EXTREMEFASE11 );
	pev->nextthink = gpGlobals->time + 1.0;
}

void CFATRONGrenade::EXTREMEFASE11( void )
{
	UTIL_ScreenShake( pev->origin, 5.0, 150.0, 10, 1000.0 );       	
	UTIL_ScreenFadeAll( Vector(255,0,0), 5, 1.0, 110, FFADE_IN );
	...
	SetThink( EXTREMEFASE12 );
	pev->nextthink = gpGlobals->time + 1.1;
}

void CFATRONGrenade::EXTREMEFASE12( void )
{
	UTIL_ScreenShake( pev->origin, 5.0, 150.0, 10, 1000.0 );       	
	UTIL_ScreenFadeAll( Vector(255,0,0), 5, 1.0, 110, FFADE_IN );
	...
	SetThink( EXTREMEFASE13 );
	pev->nextthink = gpGlobals->time + 1.2;
}

void CFATRONGrenade::EXTREMEFASE13( void )
{
	UTIL_ScreenShake( pev->origin, 5.0, 150.0, 10, 1000.0 );       	
	UTIL_ScreenFadeAll( Vector(255,0,0), 5, 1.0, 110, FFADE_IN );
	...
	SetThink( EXTREMEFASE14 );
	pev->nextthink = gpGlobals->time + 1.3;
}

void CFATRONGrenade::EXTREMEFASE14( void )
{
	UTIL_ScreenShake( pev->origin, 5.0, 150.0, 10, 1000.0 );       	
	UTIL_ScreenFadeAll( Vector(255,0,0), 5, 1.0, 110, FFADE_IN );
	...
	SetThink( EXTREMEFASE15 );
	pev->nextthink = gpGlobals->time + 1.4;
}

void CFATRONGrenade::EXTREMEFASE15( void )
{
	UTIL_ScreenShake( pev->origin, 5.0, 150.0, 10, 1000.0 );          	
	UTIL_ScreenFadeAll( Vector(255,0,0), 5, 0.5, 200, FFADE_IN );
	...
	MESSAGE_BEGIN( MSG_BROADCAST, SVC_TEMPENTITY );
		...
		WRITE_SHORT( PRECACHE_MODEL( "sprites/laserbeam.spr" ) );
	...
	SetThink( EXTREMEFASE16 );
	pev->nextthink = gpGlobals->time + 1.5;
}

void CFATRONGrenade::EXTREMEFASE16( void )
{
	UTIL_ScreenShake( pev->origin, 5.0, 150.0, 10, 1000.0 );         	
	UTIL_ScreenFadeAll( Vector(255,0,0), 5, 0.5, 200, FFADE_IN );
	...
	SetThink( EXTREMEFASE17 );
	pev->nextthink = gpGlobals->time + 1.6;
}

void CFATRONGrenade::EXTREMEFASE17( void )
{
	UTIL_ScreenShake( pev->origin, 5.0, 150.0, 10, 1000.0 );           	
	UTIL_ScreenFadeAll( Vector(255,0,0), 5, 0.5, 200, FFADE_IN );
	...
	SetThink( EXTREMEFASE18 );
	pev->nextthink = gpGlobals->time + 1.7;
}

void CFATRONGrenade::EXTREMEFASE18( void )
{
	UTIL_ScreenShake( pev->origin, 5.0, 150.0, 10, 1000.0 );       	
	UTIL_ScreenFadeAll( Vector(255,0,0), 5, 1.0, 110, FFADE_IN );
	...
	SetThink( EXTREMEFASE19 );
	pev->nextthink = gpGlobals->time + 1.8;
}

void CFATRONGrenade::EXTREMEFASE19( void )
{
	UTIL_ScreenShake( pev->origin, 5.0, 150.0, 10, 1000.0 );       	
	UTIL_ScreenFadeAll( Vector(255,0,0), 5, 1.0, 110, FFADE_IN );
	...
	SetThink( EXTREMEFASE20 );
	pev->nextthink = gpGlobals->time + 1.9;
}

void CFATRONGrenade::EXTREMEFASE20( void )
{
	UTIL_ScreenShake( pev->origin, 5.0, 150.0, 10, 1000.0 );       	
	UTIL_ScreenFadeAll( Vector(255,0,0), 5, 1.0, 110, FFADE_IN );
	...
	SetThink( EXTREMEFASE21 );
	pev->nextthink = gpGlobals->time + 2.0;
}

void CFATRONGrenade::EXTREMEFASE21( void )
{
	UTIL_ScreenShake( pev->origin, 5.0, 150.0, 10, 1000.0 );       	
	UTIL_ScreenFadeAll( Vector(255,0,0), 5, 1.0, 110, FFADE_IN );
	...
	SetThink( EXTREMEFASE22 );
	pev->nextthink = gpGlobals->time + 2.1;
}

void CFATRONGrenade::EXTREMEFASE22( void )
{
	UTIL_ScreenShake( pev->origin, 5.0, 150.0, 10, 1000.0 );       	
	UTIL_ScreenFadeAll( Vector(255,0,0), 5, 1.0, 110, FFADE_IN );
	...
	SetThink( EXTREMEFASE23 );
	pev->nextthink = gpGlobals->time + 2.2;
}

void CFATRONGrenade::EXTREMEFASE23( void )
{
	UTIL_ScreenShake( pev->origin, 5.0, 150.0, 10, 1000.0 );       	
	UTIL_ScreenFadeAll( Vector(255,0,0), 5, 1.0, 110, FFADE_IN );
	...
	SetThink( EXTREMEFASE24 );
	pev->nextthink = gpGlobals->time + 2.3;
}

void CFATRONGrenade::EXTREMEFASE24( void )
{
	UTIL_ScreenShake( pev->origin, 5.0, 150.0, 10, 1000.0 );       	
	UTIL_ScreenFadeAll( Vector(255,0,0), 5, 1.0, 110, FFADE_IN );
	...
	SetThink( EXTREMEFASE25 );
	pev->nextthink = gpGlobals->time + 2.4;
}

void CFATRONGrenade::EXTREMEFASE25( void )
{
	UTIL_ScreenShake( pev->origin, 5.0, 150.0, 10, 1000.0 );       	
	UTIL_ScreenFadeAll( Vector(255,0,0), 5, 1.0, 110, FFADE_IN );
	...
	SetThink( EXTREMEFASE26 );
	pev->nextthink = gpGlobals->time + 2.5;
}

void CFATRONGrenade::EXTREMEFASE26( void )
{
	UTIL_ScreenShake( pev->origin, 5.0, 150.0, 6, 1000.0 );       	
	UTIL_ScreenFadeAll( Vector(255,0,0), 5, 1.0, 110, FFADE_IN );
	...
	SetThink( EXTREMEFASE27 );
	pev->nextthink = gpGlobals->time + 2.6;
}

void CFATRONGrenade::EXTREMEFASE27( void )
{
 	UTIL_ScreenShake( pev->origin, 5.0, 150.0, 10, 1000.0 );       	
	UTIL_ScreenFadeAll( Vector(255,0,0), 5, 1.0, 110, FFADE_IN );   
	...
	SetThink( EXTREMEFASEFINAL );
	pev->nextthink = gpGlobals->time + 2.7;
}

void CFATRONGrenade::EXTREMEFASEFINAL( void )
{
 	entvars_t	*pevOwner;
    ...
    CBaseEntity::Create( "ammo_firefatron", pev->origin, pev->angles, edict() );
	RadiusDamage ( pev->origin, pev, pevOwner, 10, 50, CLASS_NONE );

    pev->effects |= EF_NODRAW;

	SetThink( EXTREMEFASEFINAL2 );
	pev->nextthink = gpGlobals->time + 2.0;
}

void CFATRONGrenade::EXTREMEFASEFINAL2( void )
{
	EMIT_SOUND(ENT(pev), CHAN_ITEM, "weapons/fatrongrenade/citadel_end_explosion1.wav", 1, ATTN_NORM);
	UTIL_Remove( this );
}
