...
void CSporelauncher::SecondaryAttack(void)
{
	...
	UTIL_MakeVectors( m_pPlayer->pev->v_angle );
	Vector vecSrc = m_pPlayer->GetGunPosition( ) + gpGlobals->v_forward * 16 + gpGlobals->v_right * 8 + gpGlobals->v_up * -8;
	Vector vecSrc2 = m_pPlayer->GetGunPosition( ) + gpGlobals->v_forward * 26 + gpGlobals->v_right * 8 + gpGlobals->v_up * -8;
	Vector vecSrc3 = m_pPlayer->GetGunPosition( ) + gpGlobals->v_forward * 36 + gpGlobals->v_right * 8 + gpGlobals->v_up * -8;
	Vector vecSrc4 = m_pPlayer->GetGunPosition( ) + gpGlobals->v_forward * 46 + gpGlobals->v_right * 8 + gpGlobals->v_up * -8;
	Vector vecSrc5 = m_pPlayer->GetGunPosition( ) + gpGlobals->v_forward * 56 + gpGlobals->v_right * 8 + gpGlobals->v_up * -8;
		...
		CSpore2 *pSpore2 = CSpore2::CreateSpore2Grenade( vecSrc2, m_pPlayer->pev->v_angle, m_pPlayer, FALSE );
		UTIL_MakeVectors( m_pPlayer->pev->v_angle );
		pSpore2->pev->velocity = pSpore2->pev->velocity + gpGlobals->v_forward * 900;

		CSpore3 *pSpore3 = CSpore3::CreateSpore3Grenade( vecSrc3, m_pPlayer->pev->v_angle, m_pPlayer, FALSE );
		UTIL_MakeVectors( m_pPlayer->pev->v_angle );
		pSpore3->pev->velocity = pSpore3->pev->velocity + gpGlobals->v_forward * 1100;

		CSpore4 *pSpore4 = CSpore4::CreateSpore4Grenade( vecSrc4, m_pPlayer->pev->v_angle, m_pPlayer, FALSE );
		UTIL_MakeVectors( m_pPlayer->pev->v_angle );
		pSpore4->pev->velocity = pSpore4->pev->velocity + gpGlobals->v_forward * 1300;

		CSpore5 *pSpore5 = CSpore5::CreateSpore5Grenade( vecSrc5, m_pPlayer->pev->v_angle, m_pPlayer, FALSE );
		UTIL_MakeVectors( m_pPlayer->pev->v_angle );
		pSpore5->pev->velocity = pSpore5->pev->velocity + gpGlobals->v_forward * 1500;
#endif
