...
#define DISPLACER_SECONDARY_USAGE 100
...
void CDisplacer::Displace( void )
{
	...
	CDisplacerBall::Shoot( m_pPlayer->pev, vecSrc, gpGlobals->v_forward * 1500, m_pPlayer->pev->v_angle );
...
// Purpose2:
//=========================================================
void CDisplacer::Displace2( void )
{
	ClearBeams();
	ClearSpin();
	...
	CDisplacerBall::Shoot( m_pPlayer->pev, vecSrc, gpGlobals->v_forward * 1500, m_pPlayer->pev->v_angle );
	CDisplacerBall::Shoot( m_pPlayer->pev, vecSrc, gpGlobals->v_forward * 1300, m_pPlayer->pev->v_angle );
	CDisplacerBall::Shoot( m_pPlayer->pev, vecSrc, gpGlobals->v_forward * 1100, m_pPlayer->pev->v_angle );
	CDisplacerBall::Shoot( m_pPlayer->pev, vecSrc, gpGlobals->v_forward * 800, m_pPlayer->pev->v_angle );
	CDisplacerBall::Shoot( m_pPlayer->pev, vecSrc, gpGlobals->v_forward * 600, m_pPlayer->pev->v_angle );
