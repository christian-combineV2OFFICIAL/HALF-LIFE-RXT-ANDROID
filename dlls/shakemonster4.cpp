...
class CShakemonster4 : public CBaseMonster
{
public:
	void Spawn( void );
	void Precache( void );
...
LINK_ENTITY_TO_CLASS( monster_shake4, CShakemonster4 );

//=========================================================
// Spawn
//=========================================================
void CShakemonster4 :: Spawn()
{
	Precache( );
...
//=========================================================
void CShakemonster4 :: Precache()
{
	PRECACHE_MODEL("models/null.mdl");
}	

void CShakemonster4 :: Remove ( void )
{
	UTIL_Remove( this );
}
