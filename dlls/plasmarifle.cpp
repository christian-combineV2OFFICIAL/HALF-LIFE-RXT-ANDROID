...
void CPlasmarifle::Precache(void)
{
    ...
    PRECACHE_MODEL("sprites/muzzleflashredplasma.spr");
	...
	m_iMazzlePlasma = PRECACHE_MODEL("sprites/muzzleflashredplasma.spr");
...
{
#ifndef CLIENT_DLL	
	UTIL_ScreenFadeAll( Vector(255,0,0), 5, 0.5, 100, FFADE_IN );
#endif	
