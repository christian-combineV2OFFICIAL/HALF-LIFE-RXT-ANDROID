...
CGrenadeAK47 *CGrenadeAK47::ShootContact( entvars_t *pevOwner, Vector vecStart, Vector vecVelocity ){ return 0; }
void CGrenade::DetonateUse( CBaseEntity *pActivator, CBaseEntity *pCaller, USE_TYPE useType, float value ){ }

// CShockGrenade Stubs
void CShockGrenade::BounceSound( void ) { }
void CShockGrenade::Explode( Vector, Vector ) { }
void CShockGrenade::Explode( void ) { }
void CShockGrenade::Killed( entvars_t *, int ) { }
...
// CFATRONGrenade Stubs
void CFATRONGrenade::BounceSound( void ) { }
void CFATRONGrenade::Explode( Vector, Vector ) { }
void CFATRONGrenade::Explode( TraceResult *, int ) { }
void CFATRONGrenade::Killed( entvars_t *, int ) { }
...
CFATRONGrenade * CFATRONGrenade:: ShootTimed( entvars_t *pevOwner, Vector vecStart, Vector vecVelocity, float time ){ return 0; }

// CGASGrenade Stubs
CGASGrenade * CGASGrenade:: ShootGASGrenade( entvars_t *pevOwner, Vector vecStart, Vector vecVelocity, float time ){ return 0; }
...
void CBaseMonster :: MonsterInit2 ( void ) { }
...
void CBasePlayerItem :: FallInit2( void ) { }
